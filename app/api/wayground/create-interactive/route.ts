  ...
  try {
    ...
    const payload = {
      ...
      params: {
        ...
        videoMeta: {
          startTime: 0,
          endTime: typeof duration === "number" ? duration : 0,
          videoId,
    ...
    const res = await fetch(ENDPOINT, {
      ...
      headers: {
        ...
        referer: "https://wayground.com/admin/quiz",
